...
<body>
    ...
    <div class="banner">
        ...
        <h1>Mochammad Faeyza A</h1>
    <img src="{{asset('img/file0011.jpg')}}" alt="Deskripsi Gambar"class="rounded-image">
        </div>
    </div>
    ...
    <div class="box">
        <div class="box1">
            <img src="{{asset('img/paeja.jpg')}}" alt="">
            <h2>Paeja Selvi</h2>
        </div>
        <div class="box1">
        <img src="{{asset('img/lomba.jpg')}}" alt="">
            <h2>Paeja Lomba</h2>
        </div>
        <div class="box1">
        <img src="{{asset('img/konser.jpg')}}" alt="">
            <h2>Paeja Konser</h2>
        </div>
    </div>
...
<div class="contact">
    <h2>Contact</h2>
    <ul>
        <li>Email       : <a href="https://www.faeyza.com/in/faeyzaakbar/">faeyzaakbar221106@gmail.com</a></li>
        <li>Phone Number: <a href="https://www.faeyza.com/in/faeyzaakbar/">081223664677</a></li>
        <li>Social Media: <a href="https://instagram@_mchdfaeyzaa.com/namapribadi">_mchdfaeyzaa.com</a></li>
    </ul>
</div>
